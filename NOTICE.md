...
`eval-hle` packages an evaluation from **inspect_evals**.

- **Upstream:** https://github.com/UKGovernmentBEIS/inspect_evals (`src/inspect_evals/hle`)
...
- `huggingface`: `skylenage-ai/HLE-Verified`
- `huggingface`: `cais/hle-rolling`
